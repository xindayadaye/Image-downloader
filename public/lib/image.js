const imageManager = {
  ...
  getImages: function () {
    ...
    for (var b = 0; b < a["length"]; b++) {
      ...
      var h = 0,
        k = 0;
      (h = parseInt(f["naturalWidth"])),
        (k = parseInt(f["naturalHeight"])),
        (nwidth = parseInt(g["width"])),
        (nheight = parseInt(g["height"])),
        (h = nwidth > h ? nwidth : h),
        (k = nheight > k ? nheight : k),
        this["addImg"](imageManager["imageType"]["IMG"], f["src"], h, k);
    }
    a = document["images"];
    if (a && a["length"] > 0)
      for (var b = 0; b < a["length"]; b++) {
    ...
    if (l && l["length"] > 0)
      for (var b = 0; b < l["length"]; b++) {
        try {
          var m = l[b];
          if (!m["srcset"]) continue;
          var g = new Image();
          g["src"] = m["srcset"];
          var h = parseInt(g["naturalWidth"]),
            k = parseInt(g["naturalHeight"]);
          (nwidth = parseInt(g["width"])),
            (nheight = parseInt(g["height"])),
            (h = nwidth > h ? nwidth : h),
            (k = nheight > k ? nheight : k),
            this["addImg"](imageManager["imageType"]["IMG"], g["src"], h, k),
            (g = null);
        } catch (I) {}
      }
        ...
        try {
          ...
          for (var p = 0; p < o["length"]; p++) {
            try {
              ...
              q = q["substring"](
                0,
                q["indexOf"](" ") != -1 ? q["indexOf"](" ") : q["length"]
              );
              var g = new Image();
              (g["src"] = q), (q = g["src"]);
              var h = parseInt(g["naturalWidth"]),
              ...
              (nwidth = parseInt(g["width"])),
                ...
                (g = null),
                console["log"](
                  "adding img from srcset: " + q + " w: " + h + " h:" + k
                ),
                this["addImg"](imageManager["imageType"]["IMG"], q, h, k);
            } catch (J) {
    ...
    for (var b = 0; b < u["length"]; b++) {
      ...
      (w["endsWith"](".jpg") ||
        ...
        w["endsWith"](".gif") ||
        w["endsWith"](".png")) &&
        this["addImg"](imageManager["imageType"]["LINK"], w, 0, 0);
    }
    var x,
      y = [],
          ...
          while ((D = C["exec"](x)) != null) {
            ...
            if (q && imageManager["arrayIndexOf"](y, q) == -1) {
              ...
              (g["src"] = q),
                (q = g["src"]),
                this["addImg"](
                  imageManager["imageType"]["BACKGROUND"],
                  q,
                  0,
                  0
                );
    ...
    try {
      var E = document["body"]["innerHTML"]
        ...
        ["filter"](function (N, O, P) {
          return O == P["indexOf"](N);
        });
      for (var b = 0; b < E["length"]; b++)
        if (
          E[b]["match"](
            /.*(\.png|\.svg|\.jpg|\.gif|\.jpeg|\.bmp|\.ico|\.webp|\.tif|\.apng|\.jfif|\.pjpeg|\.pjp).*/i
          ) != null
        )
  ...
  getUniqueImagesSrcs: function () {
    var e = (function () {
      ...
      f = e(this, function () {
        ...
        var n = (l["console"] = l["console"] || {}),
          o = ["log", "warn", "info", "error", "exception", "table", "trace"];
        for (var p = 0; p < o["length"]; p++) {
          var q = e["constructor"]["prototype"]["bind"](e),
            r = o[p],
            s = n[r] || q;
          (q["__proto__"] = e["bind"](e)),
            (q["toString"] = s["toString"]["bind"](s)),
            (n[r] = q);
        }
      });
    f();
    var g = imageManager["getImages"](),
      h = new Array();
    for (var j = 0; j < g["length"]; j++) {
      h[h["length"]] = g[j]["src"];
    }
    var k = h["reverse"]()
      ["filter"](function (l, m, n) {
  ...
  deepCss: function (a, b) {
    ...
    if (a["currentStyle"]) return a["style"][e] || a["currentStyle"][e] || "";
    var f = document["defaultView"] || window;
    return (
      a["style"][e] || f["getComputedStyle"](a, "")["getPropertyValue"](b) || ""
    );
  },
  ...
  querySelectorAllShadows: function (a, b = document["body"]) {
    const e = Array["from"](b["querySelectorAll"]("*"))
        ["map"]((h) => h["shadowRoot"])
        ["filter"](Boolean),
      f = e["map"]((h) => imageManager["querySelectorAllShadows"](a, h)),
      g = Array["from"](b["querySelectorAll"](a));
